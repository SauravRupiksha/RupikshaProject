...
import com.rupiksha.fingpayaeps.faeps.service.EkycStatusService;
...
public class EkycController {
    ...
    public ResponseEntity<BiometricResponseDTO<Object>> biometricEkyc(
        ...
        BiometricResponseDTO<Object> response =
                biometricService.processBiometric(request);
...
// =========================
    @PostMapping("/status")
    public EkycStatusResponseDTO checkEkycStatus(
            @Valid @RequestBody EkycStatusRequest request) {

        return ekycStatusService.checkStatus(request);
    }
}